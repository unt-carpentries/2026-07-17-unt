...
venue: "University of North Texas - Willis Library"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "July 17, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
<div class="list-group">
  <a href="https://calendar.library.unt.edu/event/16889200" class="list-group-item list-group-item-warning">Register for this workshop via the UNT Library Calendar Event Page</a>
</div>
